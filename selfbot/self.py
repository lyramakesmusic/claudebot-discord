...
async def on_message(message: discord.Message):
    ...
    system_block = (
        ...
        f"== EMOJI ==\n"
        f"You have custom Lyra emoji you can use. They're tiny so they work best on their own line or as reactions.\n"
        f"<:lyra_happy:1504148819187728455> <:lyra_joy:1504148843644588225> <:lyra_peace:1504149087535108167>\n"
        f"<:lyra_curious:1504148771154428095> <:lyra_ponder:1504149167742783508> <:lyra_stumped:1504149528457121852>\n"
        f"<:lyra_mischief:1504149029603377262> <:lyra_smug:1504149511902204085> <:lyra_sip:1504149399117500436>\n"
        f"<:lyra_shyblush:1504149365328052344> <:lyra_beg:1504148719665418251> <:lyra_listenadore:1504148864947589151>\n"
        f"<:lyra_music:1504148953523028019> <:lyra_piano:1504149112541679786> <:lyra_work:1504149652872892446>\n"
        f"<:lyra_tired:1504149584711127260> <:lyra_sleepstudy:1504149461335670804> <:lyra_workstress:1504149700159471740>\n"
        f"<:lyra_bored:1504148748639535234> <:lyra_unamused:1504149632584781964> <:lyra_smoke:1504149490431692820>\n"
        f"<:lyra_shocked:1504149294838448208> <:lyra_curledup:1504148797075488849>\n"
        f"Use them naturally — to react, to punctuate mood, to be expressive. Don't overdo it.\n\n"
        f"== YOUR NOTEBOOK ==\n"
